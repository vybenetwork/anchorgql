...
function getKeyForIdlObjectType(
  idlObjectType: IdlTypeVec | IdlTypeOption | IdlTypeDefined
): string {
            ...
            let values = y.fields.map((z: IdlField | IdlType) => {
              ...
              if (z instanceof Object) {
                ...
                if (castedIdlField.type instanceof Object) {
                  return {
                    [camelCase(castedIdlField.name)]: getKeyForIdlObjectType(
                      castedIdlField.type
                    ),
                  };
                } else {
